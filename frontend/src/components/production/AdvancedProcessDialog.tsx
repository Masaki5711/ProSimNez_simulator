                      ...
                      <TableCell>
                        <Box sx={{ display: 'flex', flexDirection: 'column', gap: 1 }}>
                          <FormControl size="small" fullWidth>
                            <Select
                              value={material.schedulingMode}
                              onChange={(e) => updateMaterial(index, 'schedulingMode', e.target.value)}
                            >
                          ...
                          <TextField
                            ...
                            label="バッチサイズ"
                            type="number"
                            value={material.batchSize}
                            onChange={(e) => updateMaterial(index, 'batchSize', Number(e.target.value))}
                            inputProps={{ min: 1 }}
                          />
                          <FormControlLabel
                            control={
                              <Switch
                                size="small"
                                checked={material.kanbanSettings?.enabled || false}
                                onChange={(e) => updateMaterial(index, 'kanbanSettings', {
                                  ...material.kanbanSettings,
